...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-02 22:26`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b9a9fdf2-8b16-4284-86fe-b35874874d1b.git
$ cd b9a9fdf2-8b16-4284-86fe-b35874874d1b
```
